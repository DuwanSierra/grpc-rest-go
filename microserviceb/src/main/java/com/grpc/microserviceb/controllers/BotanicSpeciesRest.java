...
public class BotanicSpeciesRest {
    ...
    public BotanicSpeciesRest(@Autowired() IFindBotanicSpeciesQuery findBotanicSpeciesQuery, @Autowired() ICreateManyBotanicalSpeciesCommand createManyBotanicalSpeciesCommand) {
    ...
    @GetMapping
    public Mono<ArrayList<BotanicSpecieDTO>> getAllSpecies(@RequestParam(required = true) int size) throws InterruptedException {
